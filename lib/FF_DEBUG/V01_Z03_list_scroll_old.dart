...
//       (gv.dbRecordIndexes[index].mvcMv * GvDef.convLv).toStringAsFixed(1);
//
//   double aeoSet = gv.dbRecordIndexes[index].aoeSet;
//   String aoePercent = (aeoSet * 100).toStringAsFixed(0);
//
//   EmaAward emaAward = EmaAward.good;
//   if (aeoSet >= GvDef.aoeGreat) {
//     emaAward = EmaAward.great;
//   } else if (aeoSet >= GvDef.aoeGood) {
//     emaAward = EmaAward.good;
//   } else {
//     emaAward = EmaAward.bad;
//   }
//
//   return Container(
//     padding: EdgeInsets.symmetric(horizontal: asWidth(18)),
...
//                       // color: tm.grey03.withOpacity(0.1),
//                       border: Border.all(
//                           width: asWidth(1),
//                           color: emaAward == EmaAward.great
//                               ? tm.blue.withOpacity(0.2)
//                               : emaAward == EmaAward.good
//                                   ? tm.green.withOpacity(0.2)
...
//                       //-------------------------------------------------------
//                       // 성과텍스트
//                       awardText(emaAward: emaAward),
//                       // awardMark(emaAward: emaAward),
//                       // Container(
...
//                       //     child:
//                       //         FittedBoxN(child: awardText(emaAward: emaAward))),
//                       // // child: awardMark(emaAward: emaAward)),
//                       //--------------------------------------------------------
//                       // 운동량
//                       Container(
//                         alignment: Alignment.center,
