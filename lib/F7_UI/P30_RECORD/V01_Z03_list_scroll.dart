                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Icons.schedule, size: s14, color: tm.mainBlue),
                          Container(
                            width: asWidth(130),
                            alignment: Alignment.centerLeft,
                            child: FittedBoxN(
                      ...
                      // EMG 초당 25 x 20byte = 500byte = 0.5KB (시간과 데이터 = 0.4KB)
                      // ECG 초당 50 x 12byte = 600byte = 0.6KB
                      // 마크 : 초당 1개 가정 -> 8 x 3 = 24 = 0.024KB
                      TextN(
                        gv.dbRecordIndexes[index].isEcgEmpty == false
                            ? '${(0.4 + gv.dbRecordIndexes[index].exerciseTime * 1.124).toStringAsFixed(0)}kB' //심전도 데이터가 있을 경우
                            : '${(0.4 + gv.dbRecordIndexes[index].exerciseTime * 0.524).toStringAsFixed(0)}kB', //근전도 데이터만 있을 경우
                        fontSize: s14,
                        color: tm.grey03,
                        // fontWeight: FontWeight.w400,
                      ),
                    ...
                    children: [
                      Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius:
                                  BorderRadius.circular(asHeight(10))),
                          child: TextN(
                            aoeAward['shortText'],
                            color: aoeAward['color'],
                            fontSize: tm.s14,
